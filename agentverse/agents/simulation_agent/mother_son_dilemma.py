...
class FamilyDilemmaAgent(BaseAgent):
    def step(
        self,
...
@agent_registry.register("mother")
class MotherAgent(FamilyDilemmaAgent):
    def _fill_prompt_template(self, env_description: str = "") -> str:
        """Fill the placeholders in the prompt template
...
@agent_registry.register("son")
class SonAgent(FamilyDilemmaAgent):
    personality: str
    relationship_with_mother: str
    ...
    def _fill_prompt_template(self, env_description: str = "") -> str:
        ...
        role_argument = {
            ...
            "relationship_with_mother": self.relationship_with_mother,
        }
